...
# После тестирования маршрутов проекта убедимся в том, что на страницы проекта передаётся именно то содержимое, которое ожидалось.
...
# Обьединим два теста в один с помощью параметризации.
...
"""Тест «есть ли форма в контексте?» Как и в предыдущем случае — сперва напишем два отдельных теста:"""
# - тест 3 - на страницы создания и редактирования заметки передаются формы.
