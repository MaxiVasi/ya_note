...
# Последний этап тестирования проекта YaNote; при тестировании логики приложения планируется проверить такие утверждения:
...
# Теперь протестируем возможность создать две заметки с одинаковым slug.
...
# Следующий тест: если при создании заметки оставить поле slug пустым —
# то содержимое этого поля будет сформировано автоматически, из содержимого поля title.
